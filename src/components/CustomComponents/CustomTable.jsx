...

                                {
                                    columns.map((item, key) => (
                                        <Grid xs={item?.xs} key={key}>
                                            <Typography variant="tableHead" color="text.secondary" >
                                                {item?.Header}
                                            </Typography>
                                        </Grid>
                                    )
                            ...
                            {data.length > 0 && data.map((row, rowIndex) => (
                                <Box
                                    sx={{
                                        pt: 2,
                                        pb: 2,
                                        borderBottom: ((data?.length || 0) - 1 > rowIndex) ? (theme) => `dashed 1px ${theme?.palette?.grey?.[400]}` : "",
                                    }}>

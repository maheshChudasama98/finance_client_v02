            ...
            <Grid container spacing={3} sx={{ mt: 3, px: 2 }}>
              ...
              <Grid item xs={6} sm={6} md={3}>
                ...
                >
                  ...
                  <Chip
                    label={`${(
                      (Number(actionSummary?.totalExpense || 0) /
                        Number(actionSummary?.totalIn || 0)) *
                        100 || 0
                    ).toFixed(1)}% of income`}
                    color="error"
                    size="small"
                      ...
                      <Card sx={{ border: 'none', p: 2 }}>
                        ...
                        <Box sx={{ textAlign: 'center', mt: 2 }}>
                          ...
                          <Typography variant="caption" color="text.secondary" display="block">
                            % of Income:{' '}
                            {(
                              safeDivide(actionSummary?.totalNetExpense, actionSummary?.totalIn) *
                              100
                            ).toFixed(1)}
                            %
                          </Typography>
                      ...
                      <Card sx={{ border: 'none', p: 2 }}>
                        ...
                        <Box sx={{ textAlign: 'center', mt: 2 }}>
                          ...
                          <Typography variant="caption" color="text.secondary" display="block">
                            % of Income:{' '}
                            {(
                              safeDivide(actionSummary?.totalInstallment, actionSummary?.totalIn) *
                              100
                            ).toFixed(1)}
                            %
                          </Typography>
                      ...
                      <Card sx={{ border: 'none', p: 2 }}>
                        ...
                        <Box sx={{ textAlign: 'center', mt: 2 }}>
                          <Typography variant="caption" color="text.secondary" display="block">
                            Daily Avg:{' '}
                            {formatToINR(
                              safeDivide(actionSummary?.totalDebit, 30),
                              isAmountVisible
                            )}
                          </Typography>
                          <Typography variant="caption" color="text.secondary" display="block">
                      ...
                      <Card sx={{ border: 'none', p: 2 }}>
                        ...
                        <Box sx={{ textAlign: 'center', mt: 2 }}>
                          <Typography variant="caption" color="text.secondary" display="block">
                            Daily Avg:{' '}
                            {formatToINR(
                              safeDivide(actionSummary?.totalCredit, 30),
                              isAmountVisible
                            )}
                          </Typography>
                          <Typography variant="caption" color="text.secondary" display="block">
                    ...
                    <Grid item xs={6} sm={4} md={3}>
                      <Card sx={{ border: 'none', p: 2 }}>
                        <Box sx={{ textAlign: 'center', width: '100%', mb: 2 }}>
                          ...
                          <Chip
                            label={getInvestmentRatioStatus(
                              monthlyData?.analytics?.investmentRatio
                            )}
                            color={getInvestmentRatioChipColor(
                              monthlyData?.analytics?.investmentRatio
                            )}
                            size="small"
                            sx={{ mt: 1 }}
                        ...
                        <Box sx={{ textAlign: 'center', mt: 2 }}>
                          ...
                          <Typography variant="caption" color="text.secondary" display="block">
                            Status:{' '}
                            {getInvestmentRatioStatus(monthlyData?.analytics?.investmentRatio)}
                          </Typography>
                        </Box>
                      </Card>
                    </Grid>

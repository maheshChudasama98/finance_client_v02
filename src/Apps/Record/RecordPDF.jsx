...
const RecordPDF = ({ transactionList, setFlag }) => {
          ...
          {Object.keys(groupedTransactions).map((date) => (
            <View key={date}>
              ...
              {groupedTransactions[date].map((transaction, index) => (
                <View key={index} style={styles.tableRow}>
                  <Text style={[styles.tableCell, { width: '20%' }]}>
                    {transaction.CategoryDetails?.CategoryName || ''}
                  </Text>
                  <Text style={[styles.tableCell, { width: '18%' }]}>
                    {transaction.Action || ''}
                  </Text>
                  ...
                  <Text style={[styles.tableCell, { width: '18%' }]}>
                    {transaction.PartyDetails?.FullName || ''}
                  </Text>
                  <Text
                    style={[
                      styles.tableCell,
                      { width: '28%', textAlign: 'right' },
                      transaction.AccountAmount > 0 ? styles.positiveAmount : styles.negativeAmount,
                    ]}
                  >
                    {transaction.AccountAmount}
                  </Text>

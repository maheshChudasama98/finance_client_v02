...
const RecordList = ({ item, isHeader, index }) => {
    const styes = {
                        ...
                        <Box>
                            <Box
                                ...
                                sx={{
                                    ...
                                    py: isHeader ? 1.5 : 0.8,
                                    borderBottom: item?.records?.length > key + 1 ? (theme) => `dashed 1px ${theme?.palette?.grey?.[400]}` : '',
                                            ...
                                            <Stack direction="row" alignItems="center" spacing={2} >
                                                <Chip
                                                    ...
                                                    sx={{
                                                        ...
                                                        backgroundColor: lightenColor(record?.AccountDetails?.Color || "#1b925e", 0.92),
                                                    }}

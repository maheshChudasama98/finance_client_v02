...
export default function Index() {
  ...
  const tableSetData = list.map((item, index) => ({
    ...
    Active: (
      <CustomCheckbox
        loading={loadingSwitch[item?.RoleId]}
        checked={item?.isActive}
        onClick={(e) => {
          StatusChange(item?.RoleId);
          e.stopPropagation();
        }}
      />
    ),
    ...
    child: <Permission dataValues={item} />,
  }));
